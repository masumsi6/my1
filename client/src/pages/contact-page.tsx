              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@linktreepro.com</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 mb-4">
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Yes, phone support is available for premium users.</p>
                  </div>
                  <div>
                    <h4 className="font-medium">Can I schedule a demo?</h4>
                    <p className="text-sm text-gray-600">Absolutely! Contact us to schedule a personalized demo.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
